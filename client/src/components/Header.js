      ...
      <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        ...
        >
          <a href="/" class="flex items-center">
            <img src={logo} class="h-14" alt="devDirect Logo" />
          </a>
          <div class="flex justify-end items-center lg:order-2" id="btn-div">
            ...
            {user ? (
              <a
                ...
                href="#"
                class="text-white bg-blue-500 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 focus:outline-none"
              >
                Log Out
              </a>
            ) : (
